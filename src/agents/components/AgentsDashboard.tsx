                    ...
                    return (
                      <tr key={agent.id} className="hover:bg-light-base dark:hover:bg-dark-base transition-colors">
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            {agent.avatar_url ? (
                              <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-lime-accent/30 flex-shrink-0">
                                <img
                              ...
                              <div className="w-10 h-10 bg-gradient-to-br from-lime-accent to-lime-500 rounded-full flex items-center justify-center flex-shrink-0">
